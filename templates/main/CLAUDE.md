...
**Skills do NOT link to their parent index** (Skills.md links to the skills, not the other way around). Inside a skill body, never use wikilinks for external files — use paths.
