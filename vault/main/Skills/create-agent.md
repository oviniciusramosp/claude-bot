...
description: Consultative skill for creating specialized agents or reviewing existing ones. Helps decide whether a case requires a dedicated agent or if the Main Agent is sufficient. Generates the v3.5 flat per-agent structure (`<id>/agent-<id>.md` + `CLAUDE.md` + sub-indexes + `.workspace/`).
type: skill
created: 2026-04-07
updated: 2026-04-09
